...
Prompts for the xMba "Agile Work & Vibe Coding" workshop (Day 10: Ship It).

These prompts follow the workflow of the day:
...
This workflow is inspired by Zevi Arnovitz's AI development process (PM @ Meta), where structured prompts guide AI through issue creation, planning, building, review, and documentation — enabling non-technical builders to ship production-quality products.
